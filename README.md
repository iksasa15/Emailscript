...
## التحقق من عناوين البريد (في السكربت)

قبل الإرسال يتم **تنظيف** كل عنوان (إزالة مسافات زائدة وحروف عرض صفرية شائعة عند النسخ) والتحقق من **صيغة** صحيحة عبر مكتبة `email-validator`. العناوين غير الصالحة تظهر في **المعاينة** وتُتخطى ولا تُرسَل. التكرار يُزال تلقائياً.

> ملاحظة: الخطأ **Address not found** من خادم البريد يعني أن **الصندوق غير موجود** رغم صحة الصيغة — لا يمكن للسكربت معرفة ذلك إلا بعد محاولة الإرسال.
